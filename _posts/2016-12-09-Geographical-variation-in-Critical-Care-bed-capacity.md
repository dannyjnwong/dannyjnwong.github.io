...
{% highlight text %}
## Error: 'data/MSitRep-October-2016-1VHw9.xls' does not exist in current working directory ('C:/Users/Danny/Dropbox/Documents/Work/Research/dannyjnwong.github.io/_drafts').
{% endhighlight %}
...
{% highlight text %}
## Warning in file(file, "rt"): cannot open file 'data/trust.csv': No such
## file or directory
{% endhighlight %}
...
{% highlight text %}
## Warning in file(file, "rt"): cannot open file 'data/Hospital 20160921.csv':
...
{% highlight text %}
## Error: 'data/SAPE18DT5-mid-2015-ccg-syoa-estimates.xls' does not exist in current working directory ('C:/Users/Danny/Dropbox/Documents/Work/Research/dannyjnwong.github.io/_drafts').
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): found duplicated column name: Name, description, timestamp, begin, end, altitudeMode, tessellate, extrude, visibility, drawOrder, icon
{% endhighlight %}
